...
1. **Activate the SQLite Persistence Skill**: Load and execute the instructions in [.agents/skills/sqlite-persistence/SKILL.md](../skills/sqlite-persistence/SKILL.md).
