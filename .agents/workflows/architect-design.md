...
1. **Activate the Architect-Design Skill**: Load and execute the instructions in [.agents/skills/architect-design/SKILL.md](.agents/skills/architect-design/SKILL.md).
...
3. **Strict Boundaries**: Adhere to [.agents/rules/workspace.md](.agents/rules/workspace.md). Ensure all references and operations are contained within the repository workspace.
