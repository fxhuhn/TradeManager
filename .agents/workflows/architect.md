...
1. **Activate the Architect-Design Skill**: Load and execute the instructions in [.agents/skills/architect-design/SKILL.md](../skills/architect-design/SKILL.md), including the **2-Layer Abstraction Rule** and **Multi-File Orchestration Protocol**.
...
6. **Strict Boundaries & Format Requirement**: Adhere to [.agents/rules/workspace.md](../rules/workspace.md). Return only repository-relative paths, direct code diffs, or structured markdown tables. No generic text summaries.
