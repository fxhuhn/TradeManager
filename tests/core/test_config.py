...
def test_config_parsing_futures_sections(tmp_path: Path) -> None:
    """Verifies that future_asset_mapping and future_strategies are parsed and normalized correctly."""
    config_content = """
    [tws]
    host = "10.0.0.1"
    port = 9999
